        ...
        >
          <div className="story-container d-flex">
            <div className="aboutstory-text self-center">
              <div>
                <img loading="lazy" src={abouttext} alt="" />
                <img
                  loading="lazy"
                  src={storytext}
                  alt=""
          ...
          <div className="icon-container d-flex justify-content-between">
            ...
            {/* <img loading="lazy" src={iconlocation} alt="" /> */}
            <motion.svg
              width="99"
              height="99"
              viewBox="0 0 99 99"
            ...
            {/* <img loading="lazy" src={iconchat} alt="" /> */}
            <motion.svg
              width="98"
              height="98"
              viewBox="0 0 98 98"
            ...
            {/* <img loading="lazy" src={iconstar} alt="" /> */}
            <motion.svg
              width="98"
              height="98"
              viewBox="0 0 98 98"
          ...
          <div className="who-we-container d-flex">
            ...
            <div>
              <img loading="lazy" src={about_group1} alt="" />
            </div>
          </div>
          ...
          <div className="launch-container company-container">
            ...
            <div className="d-flex">
              ...
              <img loading="lazy" src={about_shoes} alt="" />
            </div>
          </div>
