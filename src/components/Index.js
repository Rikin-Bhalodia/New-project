      ...
      <div id="smooth-wrapper">
        <div id="smooth-content">
                  ...
                  <div className="homePageBanerImageSec position-relative">
                      ...
                      <div className="bannerMenus ">
                        <ul>
                          ...
                          <li className="menuItem">
                            ...
                            <a href="#avenue" className="menuLink coralFont">
                              Avenue <br />& services
                            </a>
                            <div className="rightSideImg">
                              <div className="imgWrap">
                          ...
                          <li className="menuItem">
                            ...
                            <a href="#rent" className="menuLink coralFont">
                              Rent & <br /> Resell
                            </a>
                            <div className="rightSideImg">
                              <div className="imgWrap">
                          ...
                          <li className="menuItem">
                            ...
                            <a href="#liveShop" className="menuLink coralFont">
                              Live Shop
                            </a>
                            <div className="rightSideImg">
                              <div className="imgWrap">
                    ...
                    <div className="homePageButtonSection">
                      <div className="inenFixedBtn">
                        ...
                        {/* <!-- display menu sec --> */}
                        <div className="centerMenu mainColorBack c-menu-w">
                          <div className="searchSecbanner position-relative mb-4">
                            <form>
                              <a
                                href="javascript:void(0)"
                                className="position-absolute menuleftBtn colorWhite"
                              >
                                <i className="fa fa-search"></i>
                              </a>
                              <input
                                type="text"
                                className="menuSearch w-100 coralFont brightMainColor font-13"
                                placeholder="SEARCH FOR PRODUCTS, VIDEOS..."
                              />
                              <a
                                href="javascript:void(0)"
                                className="position-absolute menurightBtn colorWhite"
                              >
                        ...
                        <div className="whiteBackFullmenu text-center d-flex align-items-center">
                          <div className="menuScroll py-5 col-12">
                            <ul className="list-unstyled w-100">
                              <li>
                                <a
                                  href=""
                                  className="font-17 brwonColor coralFont"
                                >
                                  <span className="menuLeftImage">
                                    <img src="assets/img/leftImage.png" />
                                  </span>
                                  new in
                                  <span className="menuRightImage">
                                    <img src="assets/img/leftImage.png" />
                                  </span>
                                </a>
                              </li>
                            ...
                            <h4 className="font-17 mainColor coralFont mt-4">
                              services
                            </h4>
                            <ul className="list-unstyled w-100">
                              <li>
                          ...
                          <div className="menuClose position-absolute font-25">
          ...
          <section className="ss c-about-w minHeightSec minBannerHeight d-flex align-items-center">
            <div className="container-fluid">
              <div className="container">
                <div className="c-about-con" style="position: relative;">
                  <h4 className="">
                  ...
                  <h2 className="waviy2">
                    <i style="--i:10; letter-spacing: -10px;">W</i>
                    <i style="--i:11; letter-spacing: -10px;">E</i>
                    <i style="--i:12; letter-spacing: -10px;">L</i>
                    <i style="--i:13; letter-spacing: -10px;">C</i>
                    <i style="--i:14; letter-spacing: -10px;">O</i>
                    <i style="--i:15; letter-spacing: -10px;">M</i>
                    <i style="--i:16; letter-spacing: -10px;">E</i>
                    <br />
                    <i style="--i:17; letter-spacing: -10px;">T</i>
                    <i style="--i:18; letter-spacing: -10px;">O</i>&nbsp;&nbsp;
                    <i style="--i:19; letter-spacing: -10px;">T</i>
                    <i style="--i:20; letter-spacing: -10px;">H</i>
                    <i style="--i:21; letter-spacing: -10px;">E</i>
                    <br />
                    <i style="--i:22; letter-spacing: -10px;">W</i>
                    <i style="--i:23; letter-spacing: -10px;">O</i>
                    <i style="--i:24; letter-spacing: -10px;">R</i>
                    <i style="--i:25; letter-spacing: -10px;">L</i>
                    <i style="--i:26; letter-spacing: -10px;">D</i>&nbsp;&nbsp;
                    <i style="--i:27; letter-spacing: -10px;">O</i>
                    <i style="--i:28; letter-spacing: -10px;">F</i>
                    &nbsp;&nbsp;&nbsp;
                    {/* <!-- <span style="position:absolute;margin-top: -25px;"></span> --> */}
                  </h2>
                  <span style="position:absolute; margin-top: -180px; left: 320px;">
                    <svg
                      shape-rendering="crispEdges"
                      width="319.02579"
                      height="166.53645"
                      viewBox="0 0 319.02579 166.53645"
                      version="1.1"
                      id="demo-1"
                    ...
                    >
                      ...
                      >
                        <path
                          className="Elegance"
                          style="fill:none;stroke:#665e2a;stroke-width:6.5;stroke-linecap:butt;stroke-linejoin:miter;stroke-dasharray:none;stroke-opacity:1"
              ...
              <div className="c-about-slider">
                <div className="c-about-slider-in">
                  ...
                  <img src="assets/img/about-slider.jpg" />
                </div>
                <div className="c-about-slider-in">
                  <img src="assets/img/about-slider.jpg" />
                </div>
          ...
          <section
            ...
            id="luxary_studio"
            style="background: #665e2a;"
          >
            <div className="container">
              <div className="c-drive-con" style="position: relative;">
                <h4 className="">
                ...
                <h2 className="waviy2">
                  <i style="--i:1; letter-spacing: -10px;">D</i>
                  <i style="--i:2; letter-spacing: -10px;">i</i>
                  <i style="--i:3; letter-spacing: -10px;">v</i>
                  <i style="--i:4; letter-spacing: -10px;">e</i>&nbsp;
                  <i style="--i:5; letter-spacing: -10px;">i</i>
                  <i style="--i:6; letter-spacing: -10px;">n</i>
                  <i style="--i:7; letter-spacing: -10px;">t</i>
                  <i style="--i:8; letter-spacing: -10px;">o</i>
                  <br />
                  <i style="--i:9; letter-spacing: -10px;">t</i>
                  <i style="--i:10; letter-spacing: -10px;">h</i>
                  <i style="--i:11; letter-spacing: -10px;">e</i>&nbsp;
                  <i style="--i:12; letter-spacing: -10px;">w</i>
                  <i style="--i:13; letter-spacing: -10px;">o</i>
                  <i style="--i:14; letter-spacing: -10px;">r</i>
                  <i style="--i:15; letter-spacing: -10px;">l</i>
                  <i style="--i:16; letter-spacing: -10px;">d</i>
                  <br />
                  <i style="--i:17; letter-spacing: -10px;">o</i>
                  <i style="--i:18; letter-spacing: -10px;">f</i>&nbsp;&nbsp;
                </h2>
                <span style="position: absolute; left: 90px; top: 100px; z-index: 999;">
                  <svg
                    shape-rendering="crispEdges"
                    width="256.69977"
                    height="164.10138"
              ...
              <div className="row">
                <div className="col-md-5">
                  <div className="headerAvenueSec">
                    <h2 className="brwonColor font-100 ParisienneFont wow text-center">
                      <span className="">
                        ...
                        >
                          ...
                          >
                            <path
                              style="fill:none;stroke:#665e2a;stroke-width:5;stroke-linecap:butt;stroke-linejoin:miter;stroke-dasharray:none;stroke-opacity:1"
                    ...
                    <div
                      className="roundBtn rightDestinationbtn mb-3"
                ...
                <div className="col-md-5 text-center">
                  <span className="">
                    ...
                    >
                      ...
                      >
                        <path
                          style="fill:none;stroke:#665e2a;stroke-width:6.5;stroke-linecap:round;stroke-linejoin:miter;stroke-dasharray:none;stroke-opacity:1"
                  ...
                  <div
                    className="roundBtn rightDestinationbtn text-right"
                    style="margin-top: -50px;"
                  >
                    <a
                      href=""
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-5">
                  ...
                  <div
                    className="c-rent-img-1 wow flipInX"
                    data-wow-delay="0.5s"
                  >
                ...
                <div className="col-md-7 ml-auto ">
                  <div
                    className="c-rent-img-2 wow flipInX"
                    data-wow-delay="1.5s"
                  >
          ...
          <section className="c-live-tv minHeightSec minBannerHeight d-flex align-items-center">
            <div className="container">
              <div className="row">
                <div className="col-md-5" style="margin-top: 170px;">
                  <h2>
                    <span>
                      <svg
                        shape-rendering="crispEdges"
                      ...
                      >
                        ...
                        >
                          <path
                            style="opacity:1;fill:none;stroke:#665e2a;stroke-width:7;stroke-linecap:butt;stroke-linejoin:miter;stroke-dasharray:none;stroke-opacity:1"
          ...
          <section className="c-secian-w minHeightSec minBannerHeight d-flex align-items-center">
            <div className="container">
              <div className="c-secian-heading">
                ...
                <h2 className="waviy2 brwonColor text-uppercase coralFont">
                  <span style="--i:1">S</span>
                  <span style="--i:2">E</span>
              ...
              <div className="c-secian-con">
                <div className="row">
                  <div
                    className="col-sm-2 wow zoomInLeft delayed-section"
                    data-scrub="0.5"
                    data-wow-delay="0.5s"
                  >
                    <div className="c-secian-box">
                      <div className="c-secian-img innerContainer">
                        <img src="assets/img/secain-1.jpg" />
                      </div>
                      <h3>GUCCI</h3>
                      <a href="#"></a>
                    </div>
                  ...
                  >
                    <div className="c-secian-box">
                      <div className="c-secian-img innerContainer">
                        <img src="assets/img/secain-2.jpg" />
                      </div>
                      <h3>louis vuitton</h3>
                      <a href="#"></a>
                    </div>
                  ...
                  >
                    <div className="c-secian-box">
                      <div className="c-secian-img innerContainer">
                        <img src="assets/img/secain-3.png" />
                      </div>
                      <h3>CHANEL</h3>
                      <a href="#"></a>
                    </div>
                  ...
                  >
                    <div className="c-secian-box">
                      <div className="c-secian-img innerContainer">
                        <img src="assets/img/secain-4.png" />
                      </div>
                  ...
                  >
                    <div className="c-secian-box">
                      <div className="c-secian-img innerContainer">
                        <img src="assets/img/secain-5.jpg" />
                      </div>
                      <h3>VERSACE</h3>
                      <a href="#"></a>
                    </div>
                  ...
                  >
                    <div className="c-secian-box">
                      <div className="c-secian-img innerContainer">
                        <img src="assets/img/secain-6.jpg" />
                      </div>
                      <h3>SAINT LAURENT</h3>
                      <a href="#"></a>
                    </div>
          ...
          <section className="paddingSec minHeightSec minBannerHeight d-flex align-items-center followSec">
            <div className="container">
              <div className="row align-items-end">
                <div className="col-md-6 position-relative wow fadeInLeft">
                  <div className="row">
                    <h2
                      className="wow flipInY waviy2 brwonColor coralFont"
                  ...
                  <div
                    className="row align-items-end delayed-section"
                    data-scrub="0.5"
                  >
                    ...
                    <div className="col innerContainer">
                      <div
                        className="wow fadeInDown float-right"
                        data-wow-delay=".1s"
                ...
                <div className="col-md-3  delayed-section" data-scrub="0.5">
                  <div
                    className="wow fadeInDown innerContainer"
                    data-wow-delay=".2s"
                  >
                    <img
              ...
              <div className="row align-items-top">
                <div
                  className="width20 px-3 mt-3 wow fadeInUp  delayed-section"
                  data-scrub="0.5"
                  data-wow-delay=".1s"
                >
                ...
                <div
                  className="width30 px-3 mt-3 wow fadeInUp  delayed-section"
                  data-scrub="0.5"
                  data-wow-delay=".2s"
                >
                  <figure className="innerContainer">
          ...
          {/* <!-- Membership --> */}
          <section className="c-member-w paddingSec minHeightSec minBannerHeight d-flex align-items-center">
            <div className="container">
              <h2 className="wow flipInY" data-wow-delay="0.5s">
                <h2 className="waviy2">
                  ...
                  <h2>
                    <span style="z-index: 1;">
                      ...
                      >
                        ...
                        >
                          <path
                            style="opacity:1;fill:none;stroke:#665e2a;stroke-width:6;stroke-linecap:butt;stroke-linejoin:miter;stroke-dasharray:none;stroke-opacity:1"
                    ...
                    <i style="letter-spacing: 4px; margin-top: -50px; z-index: -1;">
                      WITH US
                    </i>
                  </h2>
